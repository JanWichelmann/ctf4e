...
namespace Ctf4e.Server.Migrations
{
    ...
    [Migration("20241016153430_AddGenericLabUserCredentials")]
    partial class AddGenericLabUserCredentials
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ctf4e.Server.Data.Entities.SlotEntity", b =>
                {
                    ...
                    b.Property<DateTime?>("DefaultExecuteLabEnd")
                        .HasColumnType("datetime(6)");

                    b.Property<int?>("DefaultExecuteLabId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DefaultExecuteLabId");
            ...
            modelBuilder.Entity("Ctf4e.Server.Data.Entities.SlotEntity", b =>
                {
                    b.HasOne("Ctf4e.Server.Data.Entities.LabEntity", "DefaultExecuteLab")
                        .WithMany()
                        .HasForeignKey("DefaultExecuteLabId");

                    b.Navigation("DefaultExecuteLab");
                });
