...
namespace Ctf4e.LessonServer.Models.State
{
    ...
    public abstract class UserStateFileExerciseEntry
    {
        ...
        public abstract bool Update(LessonConfigurationExerciseEntry exercise);
        ...
        /// <returns></returns>
        public abstract bool ValidateInput(LessonConfigurationExerciseEntry exercise, object input);
        ...
        /// <param name="exercise">Exercise data.</param>
        /// <returns></returns>
        public abstract string FormatDescriptionString(LessonConfigurationExerciseEntry exercise);
    }
}