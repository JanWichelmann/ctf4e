...
namespace Ctf4e.LessonServer.Models.State
{
    ...
    {
        public static UserStateFileMultipleChoiceExerciseEntry CreateState(LessonConfigurationMultipleChoiceExerciseEntry exercise)
        {
        ...
        {
            if(!(exercise is LessonConfigurationMultipleChoiceExerciseEntry multipleChoiceExercise))
