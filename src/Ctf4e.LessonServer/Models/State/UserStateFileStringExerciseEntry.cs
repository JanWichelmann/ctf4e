...
namespace Ctf4e.LessonServer.Models.State
{
    public class UserStateFileStringExerciseEntry : UserStateFileExerciseEntry
    {
        ...
        public static UserStateFileStringExerciseEntry CreateState(LessonConfigurationStringExerciseEntry exercise)
        {
        ...
        {
            if(!(exercise is LessonConfigurationStringExerciseEntry stringExercise))
