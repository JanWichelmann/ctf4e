...
namespace Ctf4e.LessonServer.Configuration.Exercises
{
    ...
    public abstract class LessonConfigurationExerciseEntry
    {
        /// <summary>
        ...
        /// <summary>
        /// Used to identify the lesson's exercises in the CTF system. Can be null.
        /// </summary>
        ...
        /// </summary>
        public LessonConfigurationExerciseEntryType Type { get; set; }
