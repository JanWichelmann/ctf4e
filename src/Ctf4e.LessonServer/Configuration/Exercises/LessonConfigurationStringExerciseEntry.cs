...
namespace Ctf4e.LessonServer.Configuration.Exercises
{
    ...
    /// </summary>
    public class LessonConfigurationStringExerciseEntry : LessonConfigurationExerciseEntry
    {
        /// <summary>
        ...
        public LessonOptionsStringExerciseSolutionEntry[] ValidSolutions { get; set; }
    ...
    public class LessonOptionsStringExerciseSolutionEntry
    {
