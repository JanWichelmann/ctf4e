...
namespace Ctf4e.LessonServer.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public AuthenticationController(ICryptoService cryptoService, IStateService stateService, IOptionsSnapshot<LessonOptions> lessonOptions, ILessonConfigurationService lessonConfiguration)
            : base("~/Views/Authentication.cshtml", lessonOptions, lessonConfiguration)
        {
