...
namespace Ctf4e.LessonServer.Controllers
{
    ...
    public class GroupController : ControllerBase
    {
        ...
        public GroupController(IStateService stateService, ICtfApiClient ctfApiClient, IOptionsSnapshot<LessonOptions> lessonOptions, ILessonConfigurationService lessonConfiguration, ILogger<GroupController> logger)
            : base("~/Views/Group.cshtml", lessonOptions, lessonConfiguration)
        {
        ...
        private async Task<bool> CheckInputAsync(int exerciseId, object input)
        {
            ...
            // Notify CTF system
            int? exerciseNumber = _lessonConfiguration.CurrentConfiguration.Exercises.FirstOrDefault(e => e.Id == exerciseId)?.CtfExerciseNumber;
